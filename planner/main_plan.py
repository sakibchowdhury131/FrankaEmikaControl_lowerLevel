...
Q_START = np.array([0.0, -0.785, 0.0, -2.856, 0.0, 1.500, 0.785])
Q_END   = np.array([0.5, -1.485, 2.0, -2.300, 0.9, 2.800, 1.785])

# Q_START = np.array([0.0, -0.785, 0.0, -2.856, 0.0, 2.800, 0.785])
# Q_END   = np.array([0.0, -1.485, 0.0, -2.300, 0.0, 2.800, 0.785])

# Q_START = np.array([0.0, -0.785, 0.0, -2.856, 0.0, 2.800, 0.785])
# Q_END   = np.array([0.0, -1.485, 0.0, -1.000, 0.0, 3.500, 0.785])

# Q_START = np.array([0.0, -1.485, 0.0, -2.000, 0.0, 3.500, 0.785])
# Q_END   = np.array([0.0, -0.785, 0.0, -2.856, 0.0, 2.800, 0.785])
